...
public class Replit_CarInsurance2 {
    public static void main(String[] args) {
        ...
        if (license.equalsIgnoreCase("Yes")){
            ...
            if (vehicleOwnership.equalsIgnoreCase("Owned")){
                premium +=10;
            }else if(vehicleOwnership.equalsIgnoreCase("Financed")
                    || vehicleOwnership.equalsIgnoreCase("Leased")){
                premium +=20;
            }
        ...
        String FirstTwoLettersOfName = name.indexOf(0)+""+name.indexOf(1);
        int nameLastIndex = name.length()-1;
        String LastTwoLettersOfName = name.substring(nameLastIndex-1,nameLastIndex);
